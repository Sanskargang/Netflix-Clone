...
export function TopRated({ props, item }) {
    ...
    function Now() {
        (async () => {
            try {
                await fetch("https://api.themoviedb.org/3/movie/top_rated?api_key=6259379dd6aa822c21edcfce778e034a")
                    .then(res => res.json())
...
export const DataSaving = memo(TopRated);