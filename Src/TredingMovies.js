...
export function Tredning({ props, item }) {
    ...
    function TredningMovies() {
        (async () => {
            try {
                await fetch("https://api.themoviedb.org/3/trending/movie/day?api_key=6259379dd6aa822c21edcfce778e034a")
                    .then(res => res.json())
...
export const DataSaving = memo(Tredning);